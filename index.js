window.addEventListener('load', function () {
    ...
    var poleChudes = {
        words: [
            ['абажур', 'Шапочка для лампочки'],
            ['крапива', 'Не огонь,а жжется'],
            ['арбуз', 'К нам приехали с бахчи полосатые мячи'],
            ['месяц', 'Рогатый,а не бодается'],
            ['молоток', 'Сам худ,а голова с пуд'],
        ['капуста', 'Семьдесят одежек,и все без застежек'],
        ['гвозди', 'Они бывают металлические и жидкие']
        ],
        selected: null,
        getWord: function () {
